...
from unicycle_motion_control import dgc_boundedcone_motion_prediction


class BoundedConeMotionPrediction:
    def __init__(self):
    ...
    def start(self):
        ...
        rospy.init_node('boundedcone_motion_prediction_node', anonymous=True)
        ...
        while not rospy.is_shutdown():
            ...
            motion_prediction_polygon = dgc_boundedcone_motion_prediction(self.position, self.orientation, self.goal_position, self.motion_direction, self.resolution)
...
if __name__ == '__main__':
    try:
        boundedcone_motion_prediction = BoundedConeMotionPrediction().start()
