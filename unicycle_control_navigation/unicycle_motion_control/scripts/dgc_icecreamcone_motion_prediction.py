...
from unicycle_motion_control import dgc_icecreamcone_motion_prediction


class IcecreamConeMotionPrediction:
    def __init__(self):
    ...
    def start(self):
        ...
        rospy.init_node('icecreamcone_motion_prediction_node', anonymous=True)
        ...
        while not rospy.is_shutdown():
            ...
            motion_prediction_polygon = dgc_icecreamcone_motion_prediction(self.position, self.orientation, self.goal_position, self.motion_direction, self.resolution)
...
if __name__ == '__main__':
    try:
        icecreamcone_motion_prediction = IcecreamConeMotionPrediction().start()
