...
from unicycle_motion_control import dgc_circle_motion_prediction


class CircularMotionPrediction:
    def __init__(self):
    ...
    def start(self):
        ...
        rospy.init_node('circle_motion_prediction_node', anonymous=True)
        ...
        while not rospy.is_shutdown():
            ...
            motion_prediction_polygon = dgc_circle_motion_prediction(self.position, self.orientation, self.goal_position, self.resolution)
...
if __name__ == '__main__':
    try:
        circular_motion_prediction = CircularMotionPrediction().start()
